 ...
 * @author CHANG
 */
public class EightPoint extends JPanel implements Serializable {
    ...
    EightPoint() {
        ...
        leftUp.addMouseMotionListener(new MouseMotionListener() {
            ...
            public void mouseDragged(MouseEvent e) {
                ...
                EightPoint.this.setBounds((int) (EightPoint.this.getX() + moveX), (int) (EightPoint.this.getY() + moveY), (int) (EightPoint.this.getWidth() - moveX), (int) (EightPoint.this.getHeight() - moveY));
                setLabel();
                for (Component c : EightPoint.this.getComponents()) {
                    if (c instanceof labelStore) {
                        BufferedImage temp = ((labelStore)c).getBufferedImage();
                        temp = EightPoint.this.scale(temp, EightPoint.this.getWidth()-10, EightPoint.this.getHeight()-10);
                        ((labelStore)c).setIcon(new ImageIcon(temp));
                        c.setBounds(5,5, EightPoint.this.getWidth()-10,EightPoint.this.getHeight()-10);
        ...
        Up.addMouseMotionListener(new MouseMotionListener() {
            ...
            public void mouseDragged(MouseEvent e) {
                double moveX = e.getX() - preTouchPoint.getX();
                double moveY = e.getY() - preTouchPoint.getY();
                EightPoint.this.setBounds(EightPoint.this.getX(), (int) (EightPoint.this.getY() + moveY), EightPoint.this.getWidth(), (int) (EightPoint.this.getHeight() - moveY));
                setLabel();
                for (Component c : EightPoint.this.getComponents()) {
                    if (c instanceof labelStore) {
                        BufferedImage temp = ((labelStore)c).getBufferedImage();
        ...
        rightUp.addMouseMotionListener(new MouseMotionListener() {
            ...
            public void mouseDragged(MouseEvent e) {
                double moveX = e.getX() - preTouchPoint.getX();
                double moveY = e.getY() - preTouchPoint.getY();
                EightPoint.this.setBounds(EightPoint.this.getX(), (int) (EightPoint.this.getY() + moveY), (int) (EightPoint.this.getWidth() + moveX), (int) (EightPoint.this.getHeight() - moveY));
                setLabel();
                for (Component c : EightPoint.this.getComponents()) {
                    if (c instanceof labelStore) {
                        BufferedImage temp = ((labelStore)c).getBufferedImage();
        ...
        right.addMouseMotionListener(new MouseMotionListener() {
            ...
            public void mouseDragged(MouseEvent e) {
                double moveX = e.getX() - preTouchPoint.getX();
                double moveY = e.getY() - preTouchPoint.getY();
                EightPoint.this.setBounds(EightPoint.this.getX(), EightPoint.this.getY(), (int) (EightPoint.this.getWidth() + moveX), EightPoint.this.getHeight());
                setLabel();
                for (Component c : EightPoint.this.getComponents()) {
                    if (c instanceof labelStore) {
                        BufferedImage temp = ((labelStore)c).getBufferedImage();
        ...
        rightButtom.addMouseMotionListener(new MouseMotionListener() {
            ...
            public void mouseDragged(MouseEvent e) {
                double moveX = e.getX() - preTouchPoint.getX();
                double moveY = e.getY() - preTouchPoint.getY();
                EightPoint.this.setBounds(EightPoint.this.getX(), (int) EightPoint.this.getY(), (int) (EightPoint.this.getWidth() + moveX), (int) (EightPoint.this.getHeight() + moveY));
                setLabel();
                for (Component c : EightPoint.this.getComponents()) {
                    if (c instanceof labelStore) {
                        BufferedImage temp = ((labelStore)c).getBufferedImage();
        ...
        Buttom.addMouseMotionListener(new MouseMotionListener() {
            ...
            public void mouseDragged(MouseEvent e) {
                double moveX = e.getX() - preTouchPoint.getX();
                double moveY = e.getY() - preTouchPoint.getY();
                EightPoint.this.setBounds(EightPoint.this.getX(), (int) EightPoint.this.getY(), (int) EightPoint.this.getWidth(), (int) (EightPoint.this.getHeight() + moveY));
                setLabel();
                for (Component c : EightPoint.this.getComponents()) {
                    if (c instanceof labelStore) {
                        BufferedImage temp = ((labelStore)c).getBufferedImage();
        ...
        leftButtom.addMouseMotionListener(new MouseMotionListener() {
            ...
            public void mouseDragged(MouseEvent e) {
                double moveX = e.getX() - preTouchPoint.getX();
                double moveY = e.getY() - preTouchPoint.getY();
                EightPoint.this.setBounds((int) (EightPoint.this.getX() + moveX), (int) EightPoint.this.getY(), (int) ((int) EightPoint.this.getWidth() - moveX), (int) (EightPoint.this.getHeight() + moveY));
                setLabel();
                for (Component c : EightPoint.this.getComponents()) {
                    if (c instanceof labelStore) {
                        BufferedImage temp = ((labelStore)c).getBufferedImage();
        ...
        left.addMouseMotionListener(new MouseMotionListener() {
            ...
            public void mouseDragged(MouseEvent e) {
                double moveX = e.getX() - preTouchPoint.getX();
                double moveY = e.getY() - preTouchPoint.getY();
                EightPoint.this.setBounds((int) (EightPoint.this.getX() + moveX), (int) EightPoint.this.getY(), (int) (EightPoint.this.getWidth() - moveX), EightPoint.this.getHeight());
                setLabel();
                for (Component c : EightPoint.this.getComponents()) {
                    if (c instanceof labelStore) {
                        BufferedImage temp = ((labelStore)c).getBufferedImage();
